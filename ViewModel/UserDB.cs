...
namespace ViewModel
{
    public class UserDB : BaseDB
    {
        ...
        public UserList SelectBySnack(Snacks snack)
        {
            command.CommandText = "SELECT * " + " FROM (TblUserSnack INNER JOIN TblUsers " + "ON tblUserSnack.UsersId = tblUsers.PersonID) " + $" WHERE UserId={snack.Id}";
